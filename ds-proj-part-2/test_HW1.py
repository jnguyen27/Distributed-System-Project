...
class TestHW1(unittest.TestCase):
  ...
  def test3(self):
    res = requests.post('http://localhost:'+str(PORT)+'/test?msg=HiJaisal')
    self.assertEqual(res.text, 'POST message received: HiJaisal', msg='Incorrect response to POST request to /test endpoint')
