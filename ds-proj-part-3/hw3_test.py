...
networkIpPrefix = "192.168.1." # should be everything up to the last period of the subnet you specified when you
...
#   However, if that is all you are doing, the following tests should fail
    ...
    def test_j_remove_node_from_network(self):
        ...
        removedNode["testScriptAddress"] = "192.168.1.3:8080"
